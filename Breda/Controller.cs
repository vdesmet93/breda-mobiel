...
namespace Controller
{
    public class Controller
    {
        ...
        private void fillDatabase()
        {
            ...
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 7, Latitude = 51.589695D, Longitude = 4.776138333333334D, Naam = "Stadhouderspoort", isUitgaan = false, Foto = 11 };
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 8, Latitude = 51.590028333333336D, Longitude = 4.774361666666667D, Naam = "Huis van Brecht", isUitgaan = false, Foto = 7 };
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 9, Latitude = 51.590195D, Longitude = 4.773445D, Naam = "Spanjaardsgat", isUitgaan = false, Foto = 21 };
            db.databaseTables.InsertOnSubmit(item);
            ...
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 11, Latitude = 51.58936166666667D, Longitude = 4.774445D, Naam = "Havermarkt", isUitgaan = true, Foto = 19 };
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 12, Latitude = 51.58883333333333D, Longitude = 4.7752783333333335D, Naam = "Grote Kerk", isUitgaan = false, Foto = 10 };
            db.databaseTables.InsertOnSubmit(item);
            ...
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 15, Latitude = 51.58741666666667D, Longitude = 4.776555D, Naam = "Grote Markt", isUitgaan = true, Foto = 17 };
            db.databaseTables.InsertOnSubmit(item);
            ...
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 21, Latitude = 51.58775D, Longitude = 4.782D, Naam = "Chasse theater", isUitgaan = true, Foto = 0 };
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 22, Latitude = 51.58775D, Longitude = 4.78125D, Naam = "Binding van Isaac", isUitgaan = false, Foto = 0 };
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 23, Latitude = 51.589666666666666D, Longitude = 4.781D, Naam = "Beyerd", isUitgaan = true, Foto = 0 };
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 24, Latitude = 51.589555D, Longitude = 4.78D, Naam = "Gasthuispoort", isUitgaan = false, Foto = 0 };
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 25, Latitude = 51.58911166666667D, Longitude = 4.777945D, Naam = "Willem Merkxtuin", isUitgaan = false, Foto = 0 };
            db.databaseTables.InsertOnSubmit(item);
