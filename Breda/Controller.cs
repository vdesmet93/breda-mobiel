    ...
    public class Controller
    {
      ...
      //      db.databaseTables.InsertOnSubmit(item);
       ...
       //     db.databaseTables.InsertOnSubmit(item);
            ...
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 4, Latitude = 51.59327833333333D, Longitude = 4.779388333333333D, Naam = "Liefdeszuster" , isUitgaan = false };
            db.databaseTables.InsertOnSubmit(item);
            ...
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 8, Latitude = 51.590028333333336D, Longitude = 4.774361666666667D, Naam = "Huis van Brecht" , isUitgaan = false };
            db.databaseTables.InsertOnSubmit(item);
            ...
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 13, Latitude = 51.588195D, Longitude = 4.7751383333333335D, Naam = "Het Poortje", isUitgaan = false };
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 14, Latitude = 51.58708333333333D, Longitude = 4.77575D, Naam = "Ridderstraat", isUitgaan = true };
            db.databaseTables.InsertOnSubmit(item);
            ...
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 22, Latitude = 51.58775D, Longitude = 4.78125D, Naam = "Binding van Isaac", isUitgaan = false };
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 23, Latitude = 51.589666666666666D, Longitude = 4.781D, Naam = "Beyerd" , isUitgaan = true };
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 24, Latitude = 51.589555D, Longitude = 4.78D, Naam = "Gasthuispoort", isUitgaan = false };
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 25, Latitude = 51.58911166666667D, Longitude = 4.777945D, Naam = "Willem Merkxtuin", isUitgaan = false };
            db.databaseTables.InsertOnSubmit(item);
            item = new DatabaseTable { Nummer = 26, Latitude = 51.589695D, Longitude = 4.778361666666667D, Naam = "Begijnenhof" , isUitgaan = false };
            db.databaseTables.InsertOnSubmit(item);
